    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#search").click(function () {
                ...
                $.ajax({
                    "url": "http://localhost:8080/itrip-biz/api/userinfo/queryuserlinkuser",
                    "type": "POST",
                    ...
                    "success": function (data) {
                        ...
                        if (data.success == "true") {
                            ...
                            $(".del").click(function () {
                                ...
                                console.log(arrs);
                                $.ajax({
                                    "url": "http://localhost:8080/itrip-biz/api/userinfo/deluserlinkuser",
                                    "type": "GET",
                                    "contentType": 'application/json',
                                    "dataType": "json",
                                    "data": arrs,
                            ...
                            $(".modify").click(function () {
                                ...
                                $.ajax({
                                    "url": "http://localhost:8080/itrip-biz/api/userinfo/getlinkusername",
                                    "type": "POST",
                                    "contentType": 'application/json',
                                    "dataType": "json",
                                    "data": arrs,
            ...
            $("#modifytijiao").click(function () {
                ...
                console.log(arrs);
                $.ajax({
                    "url": "http://localhost:8080/itrip-biz/api/userinfo/modifyuserlinkuser",
                    "type": "POST",
                    "contentType": 'application/json',
                    "dataType": "json",
                    "data": arrs,
            ...
            $("#addTijiao").click(function () {
                ...
                console.log(arrs);
                $.ajax({
                    "url": "http://localhost:8080/itrip-biz/api/userinfo/adduserlinkuser",
                    "type": "POST",
                    "contentType": 'application/json',
                    "dataType": "json",
                    "data": arrs,
